...
import BasketProductCard from '@/app/components/BasketProductCard';
...
const BasketPage = () => {
    ...
    if (groupedItems.length === 0) {
      ...
      <div className='container'>
         <div className='flex flex-col items-center justify-center mt-16'>
          <h1 className='font-[velaSans] font-medium text-content_3 mb-4'>Тут пусто... Добавь сюда что-нибудь!</h1>
  ...
  return (
   ...
   <section className="mt-4 mb-16">    
        ...
        <p className='text-content_3'>Вещи ({getTotalQuantity()}): {getTotalPrice()} ₽ </p>
